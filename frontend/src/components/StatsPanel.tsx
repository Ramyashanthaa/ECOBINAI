...
// Renders an icon + count + percentage callout outside each pie slice with a
// small connector line. Hides callouts for slivers under 4% to avoid overlap.
...
export default function StatsPanel({ stats, recentEvents }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Per-category tiles — count is the headline, % is the subtle co-star */}
